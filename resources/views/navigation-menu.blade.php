<nav x-data="{ open: false }" class="">
    ...
    <div class="bg-blue-800">
                                    ...
                                    <span class="inline-flex items-center rounded-sm">
                                        ...
                                        <button type="button"
                                            ...
                                            <div class="mr-2">
                                                ...
                                                @elseif (Auth::user()->user_type == 'professor')
                                                    {{-- PROFESSOR LOGO --}}
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                        viewBox="0 0 20 20" fill="currentColor">
                                                        <path fill-rule="evenodd"
                                            ...
                                            {{-- USER TYPE (EITHER PROFESSOR, STUDENT, ADMIN) --}}
                                            {{ __(ucfirst(Auth::user()->user_type . ':')) }}

                                            {{-- USERNAME OF THE CURRENTLY LOGGED IN ACCOUNT --}}
                                            <span class="font-bold text-blue-800 ml-1">
                                                {{ Auth::user()->name }}
                                            </span>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-600">
            <div class="py-4 border-t border-gray-50/10">
                <div class="flex items-center px-4">
                    ...
                    <div>
                        <div class="font-medium text-base text-white/80">{{ Auth::user()->name }}</div>
                        <div class="mt-2 font-normal text-xs text-white/80">{{ Auth::user()->email }}</div>
                    </div>
                </div>
                <div class="pt-2 mt-3 border-t border-gray-50/10">
