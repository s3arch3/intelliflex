        ...
        <div class="py-4 px-4 lg:px-0">
            ...
            <div class="block p-10 bg-white rounded-md shadow-sm">
                <form method="POST" action="{{ route('questions.store', ['quizID' => $quizID]) }}">
                    ...
                    <div class="mb-4">
                        <label for="quizID" class="text-sm font-normal">Creating question for Quiz ID
                            #{{ $quizID }}</label>
                    </div>
                    <div>
                        <label for="question"
                ...
                <div class="block p-10 bg-white rounded-md shadow-sm">
                    <div class="mb-4">
                        ...
                        <input id="explanationA" name="answers[0][explanation]" type="text"
                            placeholder="explanation for letter A"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="explanationB" name="answers[1][explanation]" type="text"
                            placeholder="explanation for letter B"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-4">
                        ...
                        <input id="explanationC" name="answers[2][explanation]" type="text"
                            placeholder="explanation for letter C"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="mb-4">
                        ...
                        <input id="explanationD" name="answers[3][explanation]" type="text"
                            placeholder="explanation for letter D"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <x-jet-button>
