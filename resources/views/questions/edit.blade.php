        ...
        <div class="py-4 px-4 lg:px-0">
            ...
            <div class="block p-10 bg-white rounded-md shadow-sm">
                <form method="POST" action="{{ route('questions.update', $questionItem->id) }}">
                    ...
                    <div class="mb-4">
                        <label for="quizID" class="text-sm font-normal">Editing question for Quiz ID:
                            {{ $questionItem->quiz_id }}</label>
                    </div>
                    <div>
                        <label for="question"
                            class="font-display text-xl font-bold after:content-['*'] after:ml-0.5 after:text-red-500 text-blue-800">Question
                            Name, Sir? </label>
                    ...
                    <div>
                        <label for="explanation"
                            class="font-display text-xl font-bold after:content-['*'] after:ml-0.5 after:text-red-500 text-blue-800">Explanation
                            of the question <span class="text-sm font-medium">(Will be used as a secret tool (hint)
                                later.)</span></label>
                ...
                <div class="block p-10 bg-white rounded-md shadow-sm">
                    <div class="mb-4">
                        ...
                        <input id="answerA" name="answers[0][answer]" type="text" placeholder="answer for letter A"
                            ...
                            class="mb-4 mt-2 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
