<x-app-layout>
    <x-slot name="header">
        <h2 class="font-display font-semibold font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Quiz') }}
        </h2>
    </x-slot>
            ...
            <div class="block p-10 bg-white rounded-md shadow-sm">
                <form method="POST" action="{{ route('quizzes.update', $quizItem->id) }}">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="is_active" class="ml-3 text-sm font-medium text-gray-900">Is the quiz
                            still active?</label>
                    </div>
                    <div class=" flex items-center mb-4">
