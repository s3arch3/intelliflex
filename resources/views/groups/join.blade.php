<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="block p-10 bg-white rounded-md shadow-sm overflow-hidden">
                <div class="flex flex-col items-center text-center ">
                    ...
                    <div class="mb-6 font-display text-4xl inline-flex">
                        <p class="font-bold text-blue-600"> {{ $groupProfessorItem->name}} </p>
                        <p class="ml-2 font-semibold text-gray-800"> (CODE: {{ $groupProfessorItem->code}})
                    </div>
                    ...
                    <div class="mb-2 text-gray-800">
                        ...
                        <p class="
                           ...
                           {{ $groupProfessorItem->user->name}}
                    </div>

                    <div class="mb-2">
                        <b>ID: </b> {{ $groupProfessorItem->id }}
                    </div>
                    <div class="mb-2">
                        <b>Number of Students: </b> {{ $studentCount }}
                    </div>
                    <div class="mb-2">
            ...
            <form method="POST" action="{{ route('confirmJoin', ['groupProfessorID' => $groupProfessorItem->id]) }}">
                @csrf
