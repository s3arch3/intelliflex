        ...
        <ul class="pt-2 mt-2 space-y-2 border-t border-gray-200">
            ...
            <ul class="pt-2 mt-2 space-y-2 border-t border-gray-200">
                ...
                <div>
                    ...
                    <div class="my-1 inline-flex items-center text-blue-800" role="group">
                        {{-- GROUP CODE --}}
                        <div
                            class="font-bold ml-0 mt-1 lg:mt-0 md:mt-0 lg:ml-2 md:ml-2 p-1 px-2 border-t border-b border-l bg-sky-50 rounded-l-md">
                            {{ $groupCode }}
                        </div>
                        {{-- CLIPBOARD ICON --}}
